...
export default async function Home() {
  return (
    <main className={styles.main}>
        ...
        <div className={styles.heroContent}>
          <div className={styles.heroText}>
            <h1 className={styles.heroTitle}>
              Shop Smart, <span className={styles.highlight}>Shop Easy</span>
            </h1>
            <p className={styles.heroSubtitle}>
              Discover amazing products at unbeatable prices. Order directly
              through WhatsApp for a seamless shopping experience.
            </p>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.featuresGrid}>
            <div className={styles.featureCard}>
              ...
              <p>
                Order through WhatsApp and get instant confirmation. No
            ...
            <div className={styles.featureCard}>
              ...
              <h3>Best Prices</h3>
              <p>
                Get the best deals on quality products. We ensure competitive
        ...
        <div className={styles.container}>
          ...
          <div className={styles.stepsGrid}>
            <div className={styles.step}>
              ...
              <p>
                Explore our wide range of quality products across various
                categories.
              </p>
            </div>
            ...
            <div className={styles.step}>
              ...
              <p>
                Found what you need? Click the WhatsApp button on any product.
              </p>
            </div>
            ...
            <div className={styles.step}>
              ...
              <h3>Place Order</h3>
              <p>
                Chat with us on WhatsApp to confirm your order and delivery
                details.
              </p>
            </div>
      ...
      {/* Seller CTA Section */}
      <section className={styles.sellerCta} id="seller">
        <div className={styles.container}>
          <div className={styles.sellerContent}>
            <div className={styles.sellerText}>
              <h2>Want to Sell on Our Platform?</h2>
              <p>
                Join thousands of successful sellers and grow your business with
                us. We provide you with the tools and support you need to
                succeed.
              </p>
              ...
              <Link
                href="https://wa.me/1234567890?text=Hi, I want to become a seller"
            ...
            <div className={styles.sellerImage}>
              <div className={styles.sellerCard}>
                <div className={styles.sellerCardIcon}>
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
      ...
      <section className={styles.finalCta}>
        <div className={styles.container}>
          ...
          <p>
            Discover amazing products and experience hassle-free shopping today!
          </p>
          <Link href="/explore" className={styles.btnPrimary}>
